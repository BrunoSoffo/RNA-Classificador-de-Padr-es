...
Classificador = MLPClassifier(hidden_layer_sizes = (15,10,5), alpha=1, max_iter=12000) #15,3 e 12000
...
ClassificadorPCA = MLPClassifier(hidden_layer_sizes = (50,40,30,20,10), alpha=1, max_iter=12000)
